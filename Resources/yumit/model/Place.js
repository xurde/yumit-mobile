(function(){
  Yumit.model.Place = {
    ...
    getPlacesNearby: function(/*Object*/ _args) {
      ...
      Yumit.model.request({
        method:'GET',
        action: Ti.App.Properties.base_url+'/nearby.json',
    ...
    getDishes: function(/*Object*/ _args) {
      Yumit.model.request({
        method:'GET',
        action: Ti.App.Properties.base_url+_args.place_id+'/dishes.json',
        parameters: '',
        error: function(e,xhr) {
          Yumit.ui.alert('Arguments', _args.error);
        },
    ...
    getUsers: function(/*Object*/ _args) {
      Yumit.model.request({
        method:'GET',
        action:Ti.App.Properties.base_url+_args.place_id+'/users.json',
        parameters: '',
        error: function(e,xhr) {
          Yumit.ui.alert('Arguments', _args.error);
        },
