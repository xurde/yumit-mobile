    ...
    distanceInMeters: function(place) {
  	...
  	createPlaceRow: function(_place) {
  		var row = Ti.UI.createTableViewRow({
  			selectedBackgroundColor: Yumit.styles.grayColor, //I know, this is dumb, but it's currently inconsistent x-platform
  			backgroundSelectedColor: Yumit.styles.grayColor,
  			className:'tvRow',
  			height:'auto',
  			place_id: _place.id,
