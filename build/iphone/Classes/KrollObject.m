...
//@interface yumit20Object : NSObject
//@end

@interface yumit20Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[yumit20Object class]])
		{
			for (NSString *key in [[(yumit20Object*)o modules] allKeys])
			{
